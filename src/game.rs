...
use crate::{
    despawn,
    snake::{
        snake_death_system, snake_growth_system, snake_input_system, snake_movement_system,
        snake_position_lerp_system, snake_setup_system, spawn_food_system, SnakeSegment,
    },
    GameState,
};
        ...
        app.add_system_set(SystemSet::on_enter(GameState::Playing).with_system(snake_setup_system))
            .add_system_set(
                SystemSet::on_update(GameState::Playing)
                    ...
                    .with_system(snake_death_system.after(snake_movement_system)),
            )
            .add_system_set(
